Public Class FrmGestionCompras
        ...
        For Each row As DataGridViewRow In DGVCompras.Rows
            If row.Cells(0).Value = True Then
                ...
                Try
                    ...
                    MsgBox("Se registro el Pago de Compra", MsgBoxStyle.Information)
    ...
    'Codigo del boton 
    Private Sub BtnPagarFactura_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnPagarFactura.Click
