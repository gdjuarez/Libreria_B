Public Class FrmVentas
    ...
    Private Sub BtnIngreso_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnIngreso.Click
        ...
        Else
            If Convert.ToInt32(Txtcantidad.Text) > Convert.ToInt32(TxtStock.Text) Then
                ...
                'Permito grabar igual pero esto no va
                'duplico codigo, pero REPITO ESTO NO VA
                ' ESTO NO VA
                ' ESTO NO VA
                ' ESTO NO VA
                ' ESTO NO VA
    ...
    Private Sub BtnVenta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnVenta.Click
        ...
        '            'SOLO PARA BIGOGNO QUE NO QUIERE STOCK BIEN
        '            'NO VA 
        '            'NO VA 
        '            'NO VA 
        '            NOSTOCKBIGOGNO(row.Cells(1).Value)

        '            If ControlStock - row.Cells(0).Value < 0 Then
        '                'no bajo stock
        '            Else
        '                'NO VA 
        '                'NO VA 
    ...
    'Private Sub TxtBuscarCodigoBarra_TextChanged_1(ByVal sender As Object, ByVal e As EventArgs) Handles TxtBuscarCodigoBarra.TextChanged
